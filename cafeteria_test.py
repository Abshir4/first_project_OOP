from Shopping_mall.the_house.shop_items import inventory
from Shopping_mall.the_house.shop_items import drink
from Shopping_mall.the_house.shop_items import food
